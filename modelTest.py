...
model.load_state_dict(torch.load('modelv1_acc72.pth'))  # 모델 상태 사전 로드
model.eval()  # 평가 모드 설정
...
# 이미지 로드 및 전처리
image_path = '/Users/imdohyeon/Documents/PythonWorkspace/2024WT_imgclassify7animals/thisisDog.jpeg'
